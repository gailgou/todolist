...
from wtforms import RadioField, SubmitField, StringField, PasswordField, SelectField, DateTimeLocalField
...
class TodoListForm(FlaskForm):
    ...
    category = SelectField('分类', validators=[DataRequired()], choices=[('工作', '工作'), ('生活', '生活'), ('学习', '学习'), ('亲子', '亲子'), ('家庭', '家庭')])
    priority = SelectField('优先级', validators=[DataRequired()], choices=[('P0', 'P0-最高'), ('P1', 'P1-中等'), ('P2', 'P2-普通')])
